...
<div class="container">
  <div class="row">
    <div class="col-sm-7"><div class="p-3 mb-2 bg-primary text-white">Personal Data</div></div>
    <div class="col-sm-5"><div class="p-3 mb-2 bg-primary text-white">Confirmation</div></div>
        ...
        <div class="input-group">
            <span class="input-group-btn">
                <span class="btn btn-light btn-file">
                    Browse <input class="btn btn-default btn-file " type="file" id="imgInp">
                </span>
            </span>
