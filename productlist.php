      ...
      <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="productlist.htl">Product</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav navbar-right">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link font-weight-bold">Login</a>
            </li> 
          </ul>  
        </div>
      </nav>
      ...
      <footer id="myFooter" class="container-fluid p-2">
       <div class="container-fluid p-2">
        ...
        <div class="second-bar">
           <div class="container">
                <h2 class="logo"><a href="#"><a href="#"> <img src="img/logofont.svg" width="300" height="auto" class="d-inline-block align-top" alt=""></a></h2>
